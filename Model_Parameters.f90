module Model_Parameters
        ...
        real(8), parameter :: beta   = 0.99212d0    !Discount factor
        integer, parameter :: Tret   = 36 !5         ! Years in retirement  (65-100)
        integer, parameter :: T      = 45 !6         ! Years of active life (20-64)
        ...
        real(8) :: chim= 13.10d0,    chims=43.60d0       ! Disutility from work men
        real(8) :: chif= 3.97d0,   chifs= 9.1d0       ! Disutility from work women
        ...
        real(8), parameter :: sigma_fcm=0.201d0, rho_fcm=0d0  !Stdev and persistence of fixed costs, married women
        real(8), parameter :: sigma_fcs=0.57d0, rho_fcs=0d0    !Stdev and persistence of fixed costs, single women
        real(8), parameter :: mu_fcm=0.2182d0, mu_fcs=0.0652d0   ! Mean fixed cost of LFP, women
        real(8) :: mu_fcm1=-0.0221d0, mu_fcm2=0.00041d0          !First and 2nd order term of married female cost of working
        real(8), parameter :: sigma_fcmm=0.092d0, rho_fcmm=0d0  !Stdev and persistence of fixed costs, married men
        real(8), parameter :: sigma_fcsm=0.530d0, rho_fcsm=0d0    !Stdev of fixed costs, single men
        real(8), parameter :: mu_fcmm=0.209d0, mu_fcsm=1.127d0   !Mean fixed cost of LFP, men
        real(8) :: gamma(2,3), gamma0, gamma0f  ! Returns to experience parameters
        real(8) :: AE                           ! Average earnings
        real(8) :: match=0.081d0                 ! Assortative mating parameter
        ...
        real(8) :: Gamma_redistr = 2d0*0.0139d0
        real(8) :: Psi0=0.2725d0, w05=1.70423761746912d0, w2=4.69173016308841d0
        real(8) :: Unemp_benefit, lumpsum=2d0*0.0284d0, lumpsumdum=2d0*0.09184923463949926d0
