subroutine Solvefirstactive(counter)
    ...
    real(8) :: vtest_m_aux, vtest_f_aux    
                ...
                do iuf = 1, nu
                    ...
                    do
                        ...
                        elseif(dum2>k_grid(nk)-0.001d0) then
                            V2=Uc(P2)+Ul(dum4,dum5)-(fc(1,ifc)+fcage(1,1)*(T-it)+fcage(1,2)*(T-it)**(2d0))-fcm(1,ifcm)
                        ...
                        if(dum2<0.0001d0) then
                            V3=-999999999d0
                        elseif(dum2>k_grid(nk)-0.001d0) then
                            V3=Uc(P3)+Ul(dum4,dum5)-(fc(1,ifc)+fcage(1,1)*(T-it)+fcage(1,2)*(T-it)**(2d0))-fcm(1,ifcm)
                            pnt2=(/dum2, exp_grid(ix,T-it)+1d0, exp_grid(ixm,T-it)+1d0/)
                            INTERP3D=ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm)
                            vnext = trilin_interp(k_grid, exp_grid_dum, exp_grid_dum, INTERP3D, nk, nexp, nexp, pnt2)
                    ...
                    vnext_m = pol_ev_aux(iam, ium, iaf, iuf, ifc, ifcm, MEN)%eval(pnt2)
                    vnext_f = pol_ev_aux(iam, ium, iaf, iuf, ifc, ifcm, WOMEN)%eval(pnt2)
                    ...
                    do
                        ...
                        if(dum2<0.0001d0) then
                            V2=-999999999d0
                        elseif(dum2>k_grid(nk)-0.001d0) then
                            V2=Uc(P2)+Ul(0d0,dum4)-(fc(1,ifc)+fcage(1,1)*(T-it)+fcage(1,2)*(T-it)**(2d0))
                        ...
                        if(dum2<0.0001d0) then
                            V3=-999999999d0
                        elseif(dum2>k_grid(nk)-0.001d0) then
                            V3=Uc(P3)+Ul(0d0,dum4)-(fc(1,ifc)+fcage(1,1)*(T-it)+fcage(1,2)*(T-it)**(2d0))
                            dum2=max(dum2,0d0)
                            pnt2=(/dum2, exp_grid(ix,T-it)+1d0, exp_grid(ixm,T-it)*(1d0-deltaexp)/)
                            INTERP3D=ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm)
                            vnext = trilin_interp(k_grid, exp_grid_dum, exp_grid_dum, INTERP3D, nk, nexp, nexp, pnt2)
                    ...
                    vtest_m_aux = Ucur + beta*OmegaActive(T-it)*vnext_m
                    vtest_f_aux = Ucur + beta*OmegaActive(T-it)*vnext_f                         
                    ...
                    if (V2 >= vu) then
                        ...
                        vu_m_aux = vtest_m_aux
                        vu_f_aux = vtest_f_aux                           
                    end if
                    if(dum4<0d0) then
                        pause
                    end if
                    ...
                    v_lfp(ik,ix,ixm,iam,ium,iaf,iuf,T-it,ifc,ifcm,LFP_M0,LFP_F1,MEN)=vtest_m_aux !V2
                    v_lfp(ik,ix,ixm,iam,ium,iaf,iuf,T-it,ifc,ifcm,LFP_M0,LFP_F1,WOMEN)=vtest_f_aux                                        
                    ...
                    v_lfp(ik,ix,ixm,iam,ium,iaf,iuf,T-it,ifc,ifcm,LFP_M0,LFP_F0,MEN)=vtest_m_aux !V2
                    v_lfp(ik,ix,ixm,iam,ium,iaf,iuf,T-it,ifc,ifcm,LFP_M0,LFP_F0,WOMEN)=vtest_f_aux                    
